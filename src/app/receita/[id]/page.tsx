"use client"
import { useFetchThemeal, useFetchReceitasBr } from "@/app/hook/api";
...
export default function RecipePage() {
    ...
    const { data } = useFetchThemeal<{ meals: any }>(`lookup.php?i=${id}`);
    ...
    if (!meal) return <p className="text-center p-5">Carregando receita...</p>;
